...
def plot_banner(
    title: str = "Le duel de style",
    subtitle: str = "hansard-pm-portfolio · projet 01",
) -> Figure:
    """README banner (STYLE_DUEL.md section 9, item 1): 1600x400px, title +
...
def save(fig: Figure, path) -> None:
    ...
    so the exported PNG matches STYLE_DUEL.md's stated pixel dimensions
    exactly (e.g. 8x8in -> 1600x1600px) rather than whatever a tight crop
    happens to produce.
    """
