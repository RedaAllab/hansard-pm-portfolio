...
Static weight instances used by `hansard_pm_portfolio.style` (STYLE_DUEL.md section 4). Each is SIL Open Font License 1.1 (see the accompanying `OFL-*.txt`), free to bundle and redistribute.
